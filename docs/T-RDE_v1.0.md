...
> **正本（canonical）:** 本ファイル [`kotonoha-spec/docs/T-RDE_v1.0.md`](https://github.com/zyx-corporation/kotonoha-spec/blob/main/docs/T-RDE_v1.0.md) が T-RDE v1.0 理論ガイドの唯一の公開正本である。監査セッション用の **実行プロンプト** 正本は [`t_rde_実行プロンプト_v_1_論文準拠.md`](t_rde_実行プロンプト_v_1_論文準拠.md)（§9 最小版 / §10 詳細版）。
...
**運用:** コピー＆ペーストで使う監査用プロンプトは、正本 [`t_rde_実行プロンプト_v_1_論文準拠.md`](t_rde_実行プロンプト_v_1_論文準拠.md)（§9 最小 / §10 詳細）を使う。以下は短縮版である。
