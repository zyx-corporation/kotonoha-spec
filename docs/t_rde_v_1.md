...
> **正本（canonical）:** 本ファイル [`kotonoha-spec/docs/t_rde_v_1.md`](https://github.com/zyx-corporation/kotonoha-spec/blob/main/docs/t_rde_v_1.md) が T-RDE v1.0 の唯一の公開正本である。下流リポジトリ（`kotonoha-vscode` 等）は全文コピーを置かず、本 URL へリンクすること。
