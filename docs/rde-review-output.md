...
| `lost` | Semantic elements weakened or erased—including ambiguity, pain points, responsibility, or scope—**not** inferable from deleted text alone (see [representation-of-loss.md](representation-of-loss.md)). |
...
Tools **MAY** generate or validate RDE review outputs. No tool **MUST** be assumed complete or authoritative over human judgment; see [introduction.md](introduction.md).
