...
**文書化作業も例外ではない。** 仕様文書、参考文書、日本語 companion、README、運用ルール、図表、リンク修正など、ドキュメントに対する実質的な変更は、必ず先に Issue を起票してから作業に着手する。
...
ドキュメント化、翻訳、図表追加、要求仕様化、README更新、索引更新、運用ルール修正は、内容が小さく見える場合でも、原則として作業前に Issue を作成する。

文書化 Issue には、通常の項目に加えて次を明記する。
...
これにより、文書更新が単なる整形ではなく、意味変更として追跡されるようにする。
